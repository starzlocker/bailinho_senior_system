...
/**
 * @brief Valida o horário no formato HH:MM
 *
 * Verifica se o horário está no formato correto e se é válido.
 *
 * @param horario O horário a ser validado
 * @return bool Retorna true se o horário for válido, false caso contrário
 */
bool validar_horario(const char *horario) {
    int hora, minuto;
